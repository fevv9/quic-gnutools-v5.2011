...
START_RELOC_NUMBERS (elf_qdsp6_reloc_type)
  ...
  RELOC_NUMBER (R_QDSP6_B7_PCREL_X,    22)
  RELOC_NUMBER (R_QDSP6_16_X,          23)
  RELOC_NUMBER (R_QDSP6_12_X,          24)
  RELOC_NUMBER (R_QDSP6_11_X,          25)
  RELOC_NUMBER (R_QDSP6_10_X,          26)
  RELOC_NUMBER (R_QDSP6_9_X,           27)
  RELOC_NUMBER (R_QDSP6_8_X,           28)
  RELOC_NUMBER (R_QDSP6_7_X,           29)
  RELOC_NUMBER (R_QDSP6_6_X,           30)
  /* V2 PIC */
  RELOC_NUMBER (R_QDSP6_32_PCREL,      31)
  RELOC_NUMBER (R_QDSP6_COPY,          32)
  RELOC_NUMBER (R_QDSP6_GLOB_DAT,      33)
  RELOC_NUMBER (R_QDSP6_JMP_SLOT,      34)
  RELOC_NUMBER (R_QDSP6_RELATIVE,      35)
  RELOC_NUMBER (R_QDSP6_PLT_B22_PCREL, 36)
  RELOC_NUMBER (R_QDSP6_GOTOFF_LO16,   37)
  RELOC_NUMBER (R_QDSP6_GOTOFF_HI16,   38)
  RELOC_NUMBER (R_QDSP6_GOTOFF_32,     39)
  RELOC_NUMBER (R_QDSP6_GOT_LO16,      40)
  RELOC_NUMBER (R_QDSP6_GOT_HI16,      41)
  RELOC_NUMBER (R_QDSP6_GOT_32,        42)
  RELOC_NUMBER (R_QDSP6_GOT_16,        43)
