...
START_RELOC_NUMBERS (elf_hexagon_reloc_type)
  ...
  RELOC_NUMBER (R_HEXAGON_DTPREL_32,     45)
  RELOC_NUMBER (R_HEXAGON_GD_GOT_LO16,   46)
  RELOC_NUMBER (R_HEXAGON_GD_GOT_HI16,   47)
  RELOC_NUMBER (R_HEXAGON_GD_GOT_32,     48)
  RELOC_NUMBER (R_HEXAGON_GD_GOT_16,     49)
  RELOC_NUMBER (R_HEXAGON_IE_GOT_LO16,   50)
  RELOC_NUMBER (R_HEXAGON_IE_GOT_HI16,   51)
  RELOC_NUMBER (R_HEXAGON_IE_GOT_32,     52)
  RELOC_NUMBER (R_HEXAGON_IE_GOT_16,     53)
  RELOC_NUMBER (R_HEXAGON_TPREL_LO16,    54)
  RELOC_NUMBER (R_HEXAGON_TPREL_HI16,    55)
  RELOC_NUMBER (R_HEXAGON_TPREL_32,      56)
  RELOC_NUMBER (R_HEXAGON_TPREL_16,      57)
