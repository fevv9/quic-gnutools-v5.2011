...
START_RELOC_NUMBERS (elf_hexagon_reloc_type)
  ...
  /* V2 TLS */
  RELOC_NUMBER (R_HEXAGON_DTPMOD_32,        44)
  RELOC_NUMBER (R_HEXAGON_DTPREL_LO16,      45)
  RELOC_NUMBER (R_HEXAGON_DTPREL_HI16,      46)
  RELOC_NUMBER (R_HEXAGON_DTPREL_32,        47)
  RELOC_NUMBER (R_HEXAGON_DTPREL_16,        48)
  RELOC_NUMBER (R_HEXAGON_GD_PLT_B22_PCREL, 49)
  RELOC_NUMBER (R_HEXAGON_GD_GOT_LO16,      50)
  RELOC_NUMBER (R_HEXAGON_GD_GOT_HI16,      51)
  RELOC_NUMBER (R_HEXAGON_GD_GOT_32,        52)
  RELOC_NUMBER (R_HEXAGON_GD_GOT_16,        53)
  RELOC_NUMBER (R_HEXAGON_IE_LO16,          54)
  RELOC_NUMBER (R_HEXAGON_IE_HI16,          55)
  RELOC_NUMBER (R_HEXAGON_IE_32,            56)
  RELOC_NUMBER (R_HEXAGON_IE_GOT_LO16,      57)
  RELOC_NUMBER (R_HEXAGON_IE_GOT_HI16,      58)
  RELOC_NUMBER (R_HEXAGON_IE_GOT_32,        59)
  RELOC_NUMBER (R_HEXAGON_IE_GOT_16,        60)
  RELOC_NUMBER (R_HEXAGON_TPREL_LO16,       61)
  RELOC_NUMBER (R_HEXAGON_TPREL_HI16,       62)
  RELOC_NUMBER (R_HEXAGON_TPREL_32,         63)
  RELOC_NUMBER (R_HEXAGON_TPREL_16,         64)
