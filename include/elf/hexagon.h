...
START_RELOC_NUMBERS (elf_hexagon_reloc_type)
  ...
  RELOC_NUMBER (R_HEX_GPREL16_3,	12)
  RELOC_NUMBER (R_HEX_HL16,		13)
  /* V3 */
  RELOC_NUMBER (R_HEX_B13_PCREL,	14)
  /* V4 */
  RELOC_NUMBER (R_HEX_B9_PCREL,		15)
  /* V4 (extenders) */
  RELOC_NUMBER (R_HEX_B32_PCREL_X,	16)
  RELOC_NUMBER (R_HEX_32_6_X,		17)
  /* V4 (extended) */
  ...
  RELOC_NUMBER (R_HEX_7_X,		29)
  RELOC_NUMBER (R_HEX_6_X,		30)
  /* V2 PIC */
  ...
  RELOC_NUMBER (R_HEX_GOT_32,		42)
  RELOC_NUMBER (R_HEX_GOT_16,		43)
  /* V2 TLS */
  ...
  RELOC_NUMBER (R_HEX_TPREL_32,		63)
  RELOC_NUMBER (R_HEX_TPREL_16,		64)
  /* V4 PIC */
  ...
  RELOC_NUMBER (R_HEX_GOT_16_X,		70)
  RELOC_NUMBER (R_HEX_GOT_11_X,		71)
...
#define SHF_HEX_GPREL (~SHF_MASKPROC + 1)
