...
#define qdsp6_hash_entry(E) ((qdsp6_link_hash_entry *) (E))
#define qdsp6_hash_table(I) ((qdsp6_link_hash_table *) ((I)->hash))
...
static bfd_boolean qdsp6_elf_finish_dynamic_sections
  PARAMS ((bfd *, struct bfd_link_info *));
static enum elf_reloc_type_class qdsp6_elf_reloc_type_class
  PARAMS ((const Elf_Internal_Rela *));
static bfd_vma qdsp6_elf_plt_sym_val
  PARAMS ((bfd_vma, const asection *, const arelent *));
static bfd_boolean qdsp6_elf_hash_symbol
  PARAMS ((struct elf_link_hash_entry *));

typedef struct elf_dyn_relocs qdsp6_dyn_reloc;

typedef struct _qdsp6_link_hash_entry
  {
    struct elf_link_hash_entry elf;
    /* QDSP6 data. */
    qdsp6_dyn_reloc *dyn_relocs;
  } qdsp6_link_hash_entry;

typedef struct _qdsp6_link_hash_table
  {
...
static const qdsp6_trampoline qdsp6_trampolines [] =
  {
    {
      R_QDSP6_HL16, 2 * sizeof (qdsp6_insn), 7,
      {
...
static reloc_howto_type qdsp6_elf_howto_table [] =
{
  ...
  HOWTO (R_QDSP6_PLT_B22_PCREL,	/* type  */
	 2,			/* rightshift  */
	 2,			/* size (0 = byte, 1 = short, 2 = long)  */
	 22,			/* bitsize  */
	 TRUE,			/* pc_relative  */
  ...
  HOWTO (R_QDSP6_GOTOFF_LO16,	/* type  */
	 0,			/* rightshift  */
	 2,			/* size (0 = byte, 1 = short, 2 = long)  */
	 32,			/* bitsize  */
	 FALSE,			/* pc_relative  */
  ...
  HOWTO (R_QDSP6_GOTOFF_HI16,	/* type  */
	 0,			/* rightshift  */
	 2,			/* size (0 = byte, 1 = short, 2 = long)  */
	 32,			/* bitsize  */
	 FALSE,			/* pc_relative  */
...
static const struct qdsp6_reloc_map qdsp6_reloc_map [] =
{
  ...
  /* DSO */
  { BFD_RELOC_QDSP6_COPY,          R_QDSP6_COPY,          0 },
  { BFD_RELOC_QDSP6_GLOB_DAT,      R_QDSP6_GLOB_DAT,      0 },
  { BFD_RELOC_QDSP6_JMP_SLOT,      R_QDSP6_JMP_SLOT,      0 },
  { BFD_RELOC_QDSP6_RELATIVE,      R_QDSP6_RELATIVE,      0 },
  /* PLT */
  { BFD_RELOC_QDSP6_PLT_B22_PCREL, R_QDSP6_PLT_B22_PCREL, 0 },
  /* GOT */
  { BFD_RELOC_QDSP6_GOTOFF_LO16,   R_QDSP6_GOTOFF_LO16,   0 },
  { BFD_RELOC_QDSP6_GOTOFF_HI16,   R_QDSP6_GOTOFF_HI16,   0 },
  { BFD_RELOC_32_GOTOFF,           R_QDSP6_GOTOFF_32,     0 },
  { BFD_RELOC_QDSP6_GOT_LO16,      R_QDSP6_GOT_LO16,      0 },
  { BFD_RELOC_QDSP6_GOT_HI16,      R_QDSP6_GOT_HI16,      0 },
  { BFD_RELOC_QDSP6_GOT_32,        R_QDSP6_GOT_32,        0 },
  { BFD_RELOC_QDSP6_GOT_16,        R_QDSP6_GOT_16,        0 },
};
...
(bfd *abfd ATTRIBUTE_UNUSED, bfd_reloc_code_real_type code)
{
  ...
  for (i = ARRAY_SIZE (qdsp6_reloc_map); i--;)
    if (qdsp6_reloc_map [i].bfd_reloc_val == code)
      return (qdsp6_elf_howto_table + qdsp6_reloc_map [i].elf_reloc_val);
...
static struct bfd_link_hash_entry *qdsp6_sda_base;
 ...
 asymbol **symbols)
{
  ...
  if (qdsp6_sda_base)
    {
      if (bfd_reloc_ok != qdsp6_elf_final_sda_base (obfd, NULL, &vma))
        {
...
(bfd *obfd, char **error_message, bfd_vma *psb)
{
  ...
  else if (qdsp6_sda_base != 0 && qdsp6_sda_base->type == bfd_link_hash_defined)
    {
      *psb = qdsp6_sda_base->u.def.value
	   + qdsp6_sda_base->u.def.section->output_section->vma
	   + qdsp6_sda_base->u.def.section->output_offset;
      return (bfd_reloc_ok);
    }
  else
    {
 ...
 asection *isection, bfd *obfd, char **error_message)
{
  ...
  if ((howto->type == R_QDSP6_GPREL16_0) ||
      ...
      (howto->type == R_QDSP6_GPREL16_3))
    {
      ...
      status = qdsp6_elf_final_sda_base (obfd, error_message, &sda_base);
...
static inline void
qdsp6_put_insn
(bfd *ibfd, reloc_howto_type *howto, bfd_byte *offset, qdsp6_insn insn)
{
  switch (howto->size)
    {
    case 0:
...
static bfd_boolean
qdsp6_elf_relax_section (bfd *ibfd,
                         asection *isec,
...
*/
	  ...
	  else
	    {
          ...
          if ((is_def && (((r_type == R_QDSP6_B22_PCREL)
                           && QDSP6_TRAMPLINE_NEEDED (offset, 24))
                          || ((r_type == R_QDSP6_B15_PCREL)
                              && QDSP6_TRAMPLINE_NEEDED (offset, 17))
                          || ((r_type == R_QDSP6_B13_PCREL)
                              && QDSP6_TRAMPLINE_NEEDED (offset, 15))
                          || ((r_type == R_QDSP6_B9_PCREL)
                              && QDSP6_TRAMPLINE_NEEDED (offset, 11))))
              || !is_def)
	    {
	      ...
	      if (contents == NULL)
	      {
            ...
            for (;
                 ...
                 from -= QDSP6_INSN_LEN, irel->r_addend -= QDSP6_INSN_LEN)
              {
                ...
                insn = qdsp6_get_insn (ibfd, qdsp6_elf_howto_table + r_type,
              ...
              if (!t_h)
                {
                  ...
                  isec_size += qdsp6_trampolines [0].length
                               * sizeof (qdsp6_trampolines [0].insns [0]);
                  ...
                  for (i = j = 0;
                       j < qdsp6_trampolines [0].length;
                       i += sizeof (qdsp6_trampolines [0].insns [j]), j++)
                    bfd_put_32 (ibfd, qdsp6_trampolines [0].insns [j],
                                contents + t_at + i);

                  /* Add relocations for the trampoline. */
                  if (qdsp6_trampolines [0].r_type)
                    {
                      /* Reuse the original relocation. */
                      irel->r_info
                        = ELF32_R_INFO (ELF32_R_SYM (irel->r_info),
                                        qdsp6_trampolines [0].r_type);
                      irel->r_offset = t_h->u.def.value
                                       + qdsp6_trampolines [0].offset;
              ...
              insn = qdsp6_get_insn (ibfd,
                                     qdsp6_elf_howto_table + r_type,
                                     contents + at);
              if (qdsp6_reloc_operand (qdsp6_elf_howto_table + r_type, &insn,
                                       t_at - from, NULL))
                qdsp6_put_insn (ibfd, qdsp6_elf_howto_table + r_type,
                                contents + at, insn);
...
{
  qdsp6_link_hash_entry *edir, *eind;

  edir = qdsp6_hash_entry (dir);
  eind = qdsp6_hash_entry (ind);

  if (eind->dyn_relocs)
    {
      if (edir->dyn_relocs)
	{
	  qdsp6_dyn_reloc *p, **pp;
...
(struct bfd_hash_entry *entry, struct bfd_hash_table *table, const char *string)
{
  /* Allocate the structure if it has not already been allocated by a
     subclass.  */
  if (!entry
      && !(entry = bfd_hash_allocate (table, sizeof (qdsp6_link_hash_entry))))
    return (entry);
...
(bfd *abfd)
{
  qdsp6_link_hash_table *htab;

  if (!(htab = bfd_zalloc (abfd, sizeof (*htab))))
    return NULL;

  if (!_bfd_elf_link_hash_table_init
         (&htab->elf, abfd, qdsp6_elf_link_hash_newfunc,
          sizeof (struct _qdsp6_link_hash_entry)))
    {
      free (htab);
      return NULL;
    }
  ...
  for (rel = relocs; rel < relocs + isection->reloc_count; rel++)
	  ...
	  if (h->root.type == bfd_link_hash_defined
	    ...
	    /* TODO: is this condition OK for dynamic linking? */
              if (elf_discarded_section (h->root.u.def.section)
                  && !qdsp6_kept_hash_lookup (obfd, info, ibfd, rel, h))
                {
	      ...
	      switch (r_type)
		{
		  ...
		  if (!h->root.u.def.section->output_section)
			...
			(_("%B: relocation %s for symbol `%s\' in section `%A\' " \
			   "cannot be resolved"),
			 ibfd, isection,
			 qdsp6_elf_howto_table [r_type].name, name);
                      bfd_set_error (bfd_error_bad_value);
                      return FALSE;
		    }
		}
	...
	case R_QDSP6_GOTOFF_32:
	  ...
	  if (h->plt.offset == -(bfd_vma) 1
		...
		(_("%s: relocation %s for symbol `%s\' in section `%s\' " \
		 ...
		 qdsp6_elf_howto_table [r_type].name,
		 name,
                  ...
                  if (info->shared)
                    {
                      ...
                      outrel.r_offset = htab->elf.sgot->output_section->vma
                                        ...
                                        + offset;
                      outrel.r_info = ELF32_R_INFO (0, R_QDSP6_RELATIVE);
	...
	case R_QDSP6_GOTOFF_32:
	  ...
	  if (h->plt.offset != -(bfd_vma) 1
          ...
          if (r_type == R_QDSP6_PLT_B22_PCREL)
	    break;
	  ...
	  if ((info->shared
	      ...
	      else
		{
	      ...
	      /* This reloc will be computed at runtime, so there's no
                 need to do anything now, except for R_QDSP6_32 relocations
                 that have been turned into R_QDSP6_RELATIVE.  */
	      if (!relocate)
		continue;
	    }
	  break;
	...
	case R_QDSP6_GOT_16:
	  ...
	  insn = qdsp6_get_insn (ibfd, howto, contents + rel->r_offset);

	  if (!qdsp6_reloc_operand (howto, &insn, offset, NULL)
              && h && h->root.type != bfd_link_hash_undefined)
            r = info->callbacks->reloc_overflow
                  (info, h? &h->root: NULL, name, howto->name, 0,
                   ibfd, isection, rel->r_offset);
	  else
            qdsp6_put_insn (ibfd, howto, contents + rel->r_offset, insn);
	  ...
	  insn = qdsp6_get_insn (ibfd, qdsp6_elf_howto_table + R_QDSP6_HI16,
                                 contents + rel->r_offset + 0);

	  if (!qdsp6_reloc_operand
	         (qdsp6_elf_howto_table + R_QDSP6_HI16, &insn, offset, NULL)
              && h && h->root.type != bfd_link_hash_undefined)
            r = info->callbacks->reloc_overflow
                  (info, (h ? &h->root : NULL), name,
                   qdsp6_elf_howto_table [R_QDSP6_HI16].name, 0,
                   ibfd, isection, rel->r_offset + sizeof (insn));
	  else
            qdsp6_put_insn (ibfd, qdsp6_elf_howto_table + R_QDSP6_HI16,
                            contents + rel->r_offset + 0, insn);

          /* Second instruction (LO). */
	  insn = qdsp6_get_insn (ibfd, qdsp6_elf_howto_table + R_QDSP6_LO16,
                                 contents + rel->r_offset + sizeof (insn));

	  if (!qdsp6_reloc_operand
	         (qdsp6_elf_howto_table + R_QDSP6_LO16, &insn, offset, NULL)
              && h && h->root.type != bfd_link_hash_undefined)
            r = info->callbacks->reloc_overflow
                  (info, (h ? &h->root : NULL), name,
                   qdsp6_elf_howto_table [R_QDSP6_LO16].name, 0,
                   ibfd, isection, rel->r_offset + sizeof (insn));
	  else
            qdsp6_put_insn (ibfd, qdsp6_elf_howto_table + R_QDSP6_LO16,
 ...
 asection *sec, const Elf_Internal_Rela *relocs)
{
  ...
  for (rel = relocs; rel < relocs + sec->reloc_count; rel++)
	...
	case R_QDSP6_32:
        ...
        /* FIXME: How about R_QDSP6_32_PCREL? */
	case R_QDSP6_B22_PCREL:
	case R_QDSP6_B15_PCREL:
	case R_QDSP6_B13_PCREL:
	case R_QDSP6_B7_PCREL:
	  ...
	  if ((info->shared
	      ...
	      else
		{
		  ...
		  head = ((qdsp6_dyn_reloc **) &elf_section_data (s)->local_dynrel);
		}

	      p = *head;
	      if (!p || p->sec != sec)
		{
		  p = (qdsp6_dyn_reloc *) bfd_zalloc (htab->elf.dynobj, sizeof (*p));
		  if (!p)
		    return FALSE;
          ...
          if (info->shared
                    ...
                    && !h->non_got_ref)
            {
              (*_bfd_error_handler)
                ...
                abfd, sec,
                qdsp6_elf_howto_table [r_type].name, h->root.root.string);
              bfd_set_error (bfd_error_bad_value);
              return FALSE;
            }
          break;
  ...
  for (rel = relocs; rel < relocs + sec->reloc_count; rel++)
    {
      ...
      if (r_symndx >= symtab_hdr->sh_info)
	{
	  qdsp6_link_hash_entry *eh;
	  qdsp6_dyn_reloc *p, **pp;

	  h = sym_hashes [r_symndx - symtab_hdr->sh_info];
	  eh = qdsp6_hash_entry (h);
 ...
 Elf_Internal_Sym *sym)
{
  ...
  if (h->plt.offset != -(bfd_vma) 1)
	...
	abort ();
      ...
      rela.r_offset = htab->elf.sgotplt->output_section->vma
                      + htab->elf.sgotplt->output_offset
                      + got_offset;
      rela.r_info = ELF32_R_INFO (h->dynindx, R_QDSP6_JMP_SLOT);
      rela.r_addend = 0;
  ...
  if (h->got.offset != -(bfd_vma) 1)
          ...
          && SYMBOL_REFERENCES_LOCAL (info, h))
	{
	  ...
	  rela.r_info = ELF32_R_INFO (0, R_QDSP6_RELATIVE);
      ...
      else
	{
	  ...
	  rela.r_info = ELF32_R_INFO (h->dynindx, R_QDSP6_GLOB_DAT);
	  rela.r_addend = 0;
	}
  ...
  if (h->needs_copy)
	...
	abort ();
      ...
      rela.r_offset = h->root.u.def.value
		      + h->root.u.def.section->output_section->vma
		      + h->root.u.def.section->output_offset;
      rela.r_info = ELF32_R_INFO (h->dynindx, R_QDSP6_COPY);
      rela.r_addend = 0;
      bfd_elf32_swap_reloca_out
...
(struct bfd_link_info *info, struct elf_link_hash_entry *h)
{
  ...
  /* We must generate a R_QDSP6_COPY reloc to tell the dynamic linker
  ...
  for (s = dynobj->sections; s; s = s->next)
	...
	continue;
      ...
      /* Allocate memory for the section contents.  We use bfd_zalloc here
         ...
         it does, we get a R_QDSP6_NONE relocATION instead of garbage.  */
  ...
  if (htab->elf.dynamic_sections_created)
      ...
      if (relocs)
	{
	  ...
	  if (!(info->flags & DF_TEXTREL))
	    elf_link_hash_traverse (&htab->elf, qdsp6_readonly_dynrel, info);
      ...
      /* This dynamic tag is redundant, since it can be infered by multiplying
         DT_SYMENT by nchain in DT_HASH.  If CStomer is adamant about it,
         then add it. */
      if (FALSE)
        {
      ...
      if (!_bfd_elf_add_dynamic_entry (info, DT_QDSP6_VER, 0))
        return FALSE;
    }
...
qdsp6_elf_reloc_type_class
(const Elf_Internal_Rela *rela)
{
  switch ((int) ELF32_R_TYPE (rela->r_info))
    {
    case R_QDSP6_RELATIVE:
      return reloc_class_relative;
    case R_QDSP6_JMP_SLOT:
...
#define elf_backend_final_write_processing	qdsp6_elf_final_write_processing
...
#define elf_backend_link_output_symbol_hook	qdsp6_elf_link_output_symbol_hook
#define elf_backend_copy_indirect_symbol	qdsp6_elf_copy_indirect_symbol
#define elf_backend_additional_program_headers	qdsp6_elf_additional_program_headers
#define elf_backend_ignore_discarded_relocs	qdsp6_elf_ignore_discarded_relocs
#define elf_backend_reloc_type_class		qdsp6_elf_reloc_type_class
#define elf_backend_common_definition		qdsp6_elf_common_definition
#define elf_backend_plt_sym_val		        qdsp6_elf_plt_sym_val
#define elf_backend_hash_symbol		        qdsp6_elf_hash_symbol

#define elf_backend_check_relocs		qdsp6_elf_check_relocs
#define elf_backend_adjust_dynamic_symbol	qdsp6_elf_adjust_dynamic_symbol
#define elf_backend_size_dynamic_sections	qdsp6_elf_size_dynamic_sections
#define bfd_elf32_bfd_relax_section		qdsp6_elf_relax_section
#define elf_backend_relocate_section		qdsp6_elf_relocate_section
#define elf_backend_finish_dynamic_symbol	qdsp6_elf_finish_dynamic_symbol
