...
const hexagon_operand hexagon_operands [] =
{
  ...
  { "#s16got",      16, 'i', 0,
    ...
    "#%d", NULL, NULL },
  { "#s16gdgot",      16, 'i', 0,
    BFD_RELOC_HEX_GD_GOT_16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    HEXAGON_OPERAND_IS_IMMEDIATE | HEXAGON_OPERAND_IS_SIGNED,
    "#%d", NULL, NULL },
  { "#s16iegot",      16, 'i', 0,
    BFD_RELOC_HEX_IE_GOT_16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    HEXAGON_OPERAND_IS_IMMEDIATE | HEXAGON_OPERAND_IS_SIGNED,
    "#%d", NULL, NULL },
  { "#s16dtprel",      16, 'i', 0,
    BFD_RELOC_HEX_DTPREL_16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    HEXAGON_OPERAND_IS_IMMEDIATE | HEXAGON_OPERAND_IS_SIGNED,
    "#%d", NULL, NULL },
  { "#s16tprel",      16, 'i', 0,
    BFD_RELOC_HEX_TPREL_16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    HEXAGON_OPERAND_IS_IMMEDIATE | HEXAGON_OPERAND_IS_SIGNED,
    "#%d", NULL, NULL },
  { "#s12",      12, 'i', 0,
