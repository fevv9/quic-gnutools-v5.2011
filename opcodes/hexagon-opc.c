...
const hexagon_operand hexagon_operands [] =
{
  ...
  { "#s16gdgot", 4,  16, 'i', 0,
    ...
    "#%d", NULL, NULL },
  { "#s16ie", 4,     16, 'i', 0,
    BFD_RELOC_HEX_IE_GOT_16, BFD_RELOC_HEX_IE_32_6_X, BFD_RELOC_HEX_IE_16_X,
    HEXAGON_OPERAND_IS_IMMEDIATE | HEXAGON_OPERAND_IS_SIGNED,
    "#%d", NULL, NULL },
  { "#s16iegot", 4,  16, 'i', 0,
