...
/* Return nonzero if we are assembling for V2 */
int
qdsp6_if_arch_v2
(void)
{
...
/* Return nonzero if we are assembling for V3 */
int
qdsp6_if_arch_v3
(void)
{
...
/* Return nonzero if we are assembling for V4 */
int
qdsp6_if_arch_v4
(void)
{
  return (cpu_type == QDSP6_MACH_V4);
}
