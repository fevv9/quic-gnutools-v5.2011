...
const qdsp6_operand qdsp6_operands [] =
{
  ...
  { "#s16",      16, 'i', 0,
    ...
    "#%d", NULL, NULL },
  { "#s16got",      16, 'i', 0,
    BFD_RELOC_QDSP6_GOT_16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    QDSP6_OPERAND_IS_IMMEDIATE | QDSP6_OPERAND_IS_SIGNED,
    "#%d", NULL, NULL },
  { "#s12",      12, 'i', 0,
  ...
  { "#r22:2",    22, 'i', 2,
    ...
    "@%u", NULL, NULL },
  { "#r22:2plt",    22, 'i', 2,
    BFD_RELOC_QDSP6_PLT_B22_PCREL, BFD_RELOC_NONE, BFD_RELOC_NONE,
    QDSP6_OPERAND_IS_IMMEDIATE | QDSP6_OPERAND_PC_RELATIVE | QDSP6_OPERAND_IS_SIGNED,
    "@%u", NULL, NULL },
  { "#r15:2",    15, 'i', 2,
  ...
  { "#r9:2",      9, 'i', 2,
    ...
    "@%u", NULL, NULL },
  { "#r7:2",      7, 'i', 2,
    BFD_RELOC_QDSP6_B7_PCREL,  BFD_RELOC_QDSP6_B32_PCREL_X, BFD_RELOC_QDSP6_B7_PCREL_X,
    QDSP6_OPERAND_IS_IMMEDIATE | QDSP6_OPERAND_PC_RELATIVE | QDSP6_OPERAND_IS_SIGNED,
    "@%u", NULL, NULL },
  ...
  { "#u16_lo16", 16, 'i', 0,
    ...
    "#%u", "#0x%04x", NULL },
  { "#u16_lo16got", 16, 'i', 0,
    BFD_RELOC_QDSP6_GOT_LO16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    QDSP6_OPERAND_IS_IMMEDIATE | QDSP6_OPERAND_IS_LO16,
    "#%u", "#0x%04x", NULL },
  { "#u16_lo16gotoff", 16, 'i', 0,
    BFD_RELOC_QDSP6_GOTOFF_LO16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    QDSP6_OPERAND_IS_IMMEDIATE | QDSP6_OPERAND_IS_LO16,
    "#%u", "#0x%04x", NULL },
  { "#u16_hi16", 16, 'i', 0,
    ...
    "#%u", "#0x%04x", NULL },
  { "#u16_hi16got", 16, 'i', 0,
    BFD_RELOC_QDSP6_GOT_HI16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    QDSP6_OPERAND_IS_IMMEDIATE | QDSP6_OPERAND_IS_HI16,
    "#%u", "#0x%04x", NULL },
  { "#u16_hi16gotoff", 16, 'i', 0,
    BFD_RELOC_QDSP6_GOTOFF_HI16, BFD_RELOC_NONE, BFD_RELOC_NONE,
    QDSP6_OPERAND_IS_IMMEDIATE | QDSP6_OPERAND_IS_HI16,
    "#%u", "#0x%04x", NULL },
  { "#s16_lo16", 16, 'i', 0,
    BFD_RELOC_QDSP6_LO16, BFD_RELOC_NONE, BFD_RELOC_NONE,
...
const qdsp6_operand *
qdsp6_operand_find
(const qdsp6_operand *operand, const char *suffix)
{
  size_t i;
  char *buf;
  ...
  for (i = 0; i < qdsp6_operand_count; i++)
    if (!strcmp (qdsp6_operands [i].fmt, buf))
      return (qdsp6_operands + i);
