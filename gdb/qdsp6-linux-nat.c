...
/* Transfering floating-point registers between GDB, inferiors and cores.  
   Since QDSP6 has no floating-point registers, these functions do nothing.  */
...
/* function: qdsp6_linux_fetch_inferior_registers
   description:
...
*/
static void
qdsp6_linux_fetch_inferior_registers (struct target_ops *ops,
...
/* function: qdsp6_store_register
	- store a given register
*/
static void
qdsp6_store_register (const struct regcache *regcache, int tid, int regno)
{
...
/* function: qdsp6_linux_store_inferior_registers
   description:
	- Transferring registers between GDB and inferior.
...
*/
static void
qdsp6_linux_store_inferior_registers (struct target_ops *ops,
				      struct regcache *regcache, int regno)
{
  /* Overload thread id onto process id */
  int tid;
...
void 
_initialize_qdsp6_linux_nat (void)
{
  struct target_ops *t;
  ...
  t->to_fetch_registers = qdsp6_linux_fetch_inferior_registers;
  t->to_store_registers = qdsp6_linux_store_inferior_registers;
