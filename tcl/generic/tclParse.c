				 ...
				 * termination information. */
{
	...
	if ((type & TYPE_SUBS) == 0) {
         ...
         * Scan to find the end of the range.
         * Therefore do the same as below except remove check for
         * char type.
	     */
         while (++src, --numBytes) {}
	     ...
	     */
        char gdbDollarStr[256] = {'0'};
        int strSize = ExtractGdbVarName (src, numBytes);
